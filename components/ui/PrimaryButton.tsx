...
export default function PrimaryButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`
        flex items-center gap-[8px] sm:gap-xs rounded-card px-[14px] sm:px-h-padding py-[10px] sm:py-v-padding
        font-bagel text-[14px] sm:text-[26px] transition-colors border-[3px] sm:border-4
